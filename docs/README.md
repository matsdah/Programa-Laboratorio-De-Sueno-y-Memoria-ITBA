...
|---|---|---|
| [`TODO.md`](TODO.md) | **La cola de trabajo.** Qué falta, ordenado por dependencias en hitos. Es el único lugar que lleva estado. Hoy: las dos Partes cerradas, el refactor de la interfaz y el ajuste de su barra de menú, con los veinticuatro hitos (del 0 al 23). | Al empezar y al cerrar cada módulo. |
