...
|---|---|---|
| [`TODO.md`](TODO.md) | **La cola de trabajo.** Qué falta, ordenado por dependencias en hitos. Es el único lugar que lleva estado. Hoy: las dos Partes cerradas y el refactor de la interfaz, con los veintitrés hitos (del 0 al 22). | Al empezar y al cerrar cada módulo. |
