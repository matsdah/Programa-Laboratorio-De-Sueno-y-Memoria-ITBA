...
|---|---|---|
| [`TODO.md`](TODO.md) | **La cola de trabajo.** Qué falta, ordenado por dependencias en hitos. Es el único lugar que lleva estado. Hoy: las dos Partes cerradas, el refactor de la interfaz, el ajuste de su barra de menú, la reproducción, el trabajo de rendimiento, el diseño de la ventana, la navegación desde el medio, el menú único de herramientas, la verificación de las herramientas, sus decisiones, el recorrido manual y sus pendientes, lo que encontró la auditoría del 19 de septiembre, que sigue abierto, el rediseño de la pantalla principal, la poda de la configuración de colores, las dos barras, el canalón de los canales, lo que faltaba del prototipo y la carrocería de los paneles; son los cuarenta hitos (del 0 al 39). | Al empezar y al cerrar cada módulo. |
